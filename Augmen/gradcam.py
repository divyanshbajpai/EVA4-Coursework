...
Original file is located at
    https://colab.research.google.com/drive/1iNdDHH6lKOmd73Xoheg8rHUZvUQxPEJP
"""
...
class Res18(nn.Module):
    def __init__(self, net):
        ...
        self.features_conv = nn.Sequential(self.model.conv1,
                                           self.model.bn1,
                                           self.model.layer1,
                                           self.model.layer2,
                                           self.model.layer3,
...
def gradcamimpl(net, img, classes):
  netx = Res18(net)
  netx.eval()
